...
var UNDEAD_SAMURAI = function( char_w,char_h,object_No,max_w,max_h,belong ){
    ...
    if(belong == 'p1'){
        ...
        this.image_url = "minion/undead_samurai.png";
    }
    else{
...
UNDEAD_SAMURAI.prototype.walking = function(current_tick){
    var texture = new PIXI.Texture(PIXI.BaseTexture.fromImage(this.image_url));
...
UNDEAD_SAMURAI.prototype.set_basicV = function(vx,vy){
    this.basic_velocity_x = vx;
    this.basic_velocity_y = vy;
}

UNDEAD_SAMURAI.prototype.set_status = function(hp_var){
    // Setting hp
...
UNDEAD_SAMURAI.prototype.sound_effect = function(type){
    switch (type) {
        case -1:
            // Stop all sound
            this.sound.stop();
...
UNDEAD_SAMURAI.prototype.kill = function(){
    this.sound_effect(-1);
    delete this.sound;
}

UNDEAD_SAMURAI.prototype.change_direction = function(new_direction){
    // Moving x
...
UNDEAD_SAMURAI.prototype.set_loc_by_xy = function( next_x,next_y,direction ){
...
UNDEAD_SAMURAI.prototype.check_boundary = function(){
    // x
	if(this.obj.x+this.obj.width >= this.boundary_x){
		this.vx = 0;
        this.direction = -1;
