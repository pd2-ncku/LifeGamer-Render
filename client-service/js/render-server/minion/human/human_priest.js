/* Declare Elf Archer */
var HUMAN_PRIEST = function( char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y ){
    ...
    // sound effect
    var summon = new Howl({
        src: ['human/human_priest_summon.mp3'],
        loop: false
    });
    summon.play();
    this.sound = new Howl({
    ...
    this.atk_sound = new Howl({
        src: ['human/human_priest_healing.mp3'],
        loop: true,
        volume: 0.5
    });
    // Health Bar
    ...
    console.log("Priest Total: "+ (3/2)*char_w*this.scale + ", Per Unit: " + this.hp_unit);
...
// ====================================== Create Prototype ======================================
HUMAN_PRIEST.prototype = Object.create(MINION.prototype);
// ====================================== Define constructor ======================================
HUMAN_PRIEST.prototype.constructor = HUMAN_PRIEST;
