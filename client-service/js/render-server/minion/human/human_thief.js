/* Declare human thief */
var HUMAN_THIEF = function( char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y ){
    ...
    // TODO sound effect
    var summon = new Howl({
        src: ['human/human_thief_summon.mp3'],
        loop: false
    });
    summon.play();
    this.sound = new Howl({
        src: ['human/human_thief_walking.mp3'],
        loop: true,
        volume: 0.5
    });
    this.atk_sound = new Howl({
        src: ['human/human_thief_attack.mp3'],
        loop: true,
        volume: 0.5
    });
    // Health Bar
    ...
    console.log("Assassin Total: "+ (3/2)*char_w*this.scale + ", Per Unit: " + this.hp_unit);
...
// ====================================== Create Prototype ======================================
HUMAN_THIEF.prototype = Object.create(MINION.prototype);
// ====================================== Define constructor ======================================
HUMAN_THIEF.prototype.constructor = HUMAN_THIEF;
