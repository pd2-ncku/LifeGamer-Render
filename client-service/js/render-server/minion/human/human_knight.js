/* Declare Elf Archer */
var HUMAN_KNIGHT = function( char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y ){
    ...
    console.log("Knight Total: "+ (3/2)*char_w*this.scale + ", Per Unit: " + this.hp_unit);
...
// ====================================== Create Prototype ======================================
HUMAN_KNIGHT.prototype = Object.create(MINION.prototype);
// ====================================== Define constructor ======================================
HUMAN_KNIGHT.prototype.constructor = HUMAN_KNIGHT;
