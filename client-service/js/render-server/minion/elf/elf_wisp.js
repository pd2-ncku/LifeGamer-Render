/* Declare Elf Archer */
var ELF_WISP = function( char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y ){
    /* constructor */
    ...
    console.log("Wisp Total: "+ (3/2)*char_w*this.scale + ", Per Unit: " + this.hp_unit);
...
ELF_WISP.prototype.set_init_pos = function( loc_x,loc_y ){
