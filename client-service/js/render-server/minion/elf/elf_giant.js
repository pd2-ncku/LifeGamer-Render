/* Declare Elf Archer */
var ELF_ROCK_GIANT = function( char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y ){
    /* constructor */
    ...
    console.log("Giant Total: "+ (3/2)*char_w*this.scale + ", Per Unit: " + this.hp_unit);
...
ELF_ROCK_GIANT.prototype.move = function(control){
