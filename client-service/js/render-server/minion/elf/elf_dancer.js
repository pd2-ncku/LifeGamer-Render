/* Using inheritance */
var ELF_DANCER = function(char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y){
    ...
    if(belong == 'p1'){
        ...
        this.image_url = "minion/elf/elf_dancer.png";
    }
    else{
        // setting path to p2 image
        this.image_url = "minion/elf/elf_dancer_p2.png";
    }
    // How fast it is
...
// ====================================== Create Prototype ======================================
ELF_DANCER.prototype = Object.create(MINION.prototype);
// ====================================== Define constructor ======================================
ELF_DANCER.prototype.constructor = ELF_DANCER;
