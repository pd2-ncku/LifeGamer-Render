/* Using inheritance */
var UNDEAD_ALCHEMIST = function(char_w,char_h,object_No,max_w,max_h,belong,loc_x,loc_y){
    ...
    if(belong == 'p1'){
        ...
        this.image_url = "minion/undead/undead_alchemist.png";
    }
    else{
        // setting path to p2 image
        this.image_url = "minion/undead/undead_alchemist_p2.png";
    }
    // How fast it is
...
// ====================================== Create Prototype ======================================
UNDEAD_ALCHEMIST.prototype = Object.create(MINION.prototype);
// ====================================== Define constructor ======================================
UNDEAD_ALCHEMIST.prototype.constructor = UNDEAD_ALCHEMIST;
